...
public class AppMainList {
	...
	static UserListofAddress userListofAddress;
	...
	public static void main(String[] args) {
		...
		try {
			...
			for(int i = 101; i <= 105; i++) {
				userListofAddress = new UserListofAddress();
				...
				Address homeAddress = new Address("NewYok Main Street","troy","MI","48084");
				Address homeAddress1 = new Address("SideStreet Main Street","troy","MI","48084");
