...
public class DocManip  {
	...
	public static void main(String[] args)throws Exception {
		...
		Document doc=mainObj.createDocument("C:\\Users\\mail2\\Documents\\workspace-sts-3.9.0.RELEASE\\HtcTraining\\src\\xml\\dom\\Players.xml");
		...
		Element newPlayer=doc.createElementNS(ns,"player");
				...
				Element address=doc.createElementNS(ns,"address");
					...
					street.setTextContent("Axtell Street");
			...
			mainObj.saveDoc(doc, "file:///C:/newPlayer.xml");
	}
}